 ...
 * </p>
 * <p>
 * Для использования этого конфигуратора добавьте аннотацию {@link Autowired} к полям,
 * которые требуется автоматически внедрить, и зарегистрируйте этот конфигуратор в контексте приложения.
 * </p>
 *
