...
//                UtilityMeterEntity.builder().userId("username1").readingsDate(date1).build(),
//                UtilityMeterEntity.builder().userId("username1").readingsDate(date1).build(),
//                UtilityMeterEntity.builder().userId("username1").readingsDate(date1).build(),
//                UtilityMeterEntity.builder().userId("username1").readingsDate(date2).build(),
//                UtilityMeterEntity.builder().userId("username1").readingsDate(date2).build(),
//                UtilityMeterEntity.builder().userId("username1").readingsDate(date2).build(),
//                UtilityMeterEntity.builder().userId("username2").readingsDate(date1).build(),
//                UtilityMeterEntity.builder().userId("username2").readingsDate(date1).build(),
//                UtilityMeterEntity.builder().userId("username2").readingsDate(date1).build(),
//                UtilityMeterEntity.builder().userId("username2").readingsDate(date2).build(),
//                UtilityMeterEntity.builder().userId("username2").readingsDate(date2).build(),
//                UtilityMeterEntity.builder().userId("username2").readingsDate(date2).build()
//        );
//    }
...
//                .filter(meter -> meter.getUsername().equals(userId) && meter.getReadingsDate() == date)
